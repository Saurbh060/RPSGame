import common.InputEnum;
import common.RPSCommonConstants;

import java.util.Random;
import java.util.Scanner;

public class RPSMain {
	public static InputEnum generateComputerChoice(Random random) throws InterruptedException {
	...
	public static InputEnum getUserChoice(Scanner scanner) throws InterruptedException {
	...
	public static String chooseWinner(InputEnum computerChoice, InputEnum userChoice) {
